...
public class PageController extends FreemarkerHttpServlet{
     ...
     */
    private AccessObject getActionsForPage( VitroRequest vreq ) throws Exception{
        String uri = vreq.getWebappDaoFactory().getPageDao().getRequiredActions( getPageUri(vreq) );
        return new NamedAccessObject(uri);
    }
...
*/
    ...
    private Map<String,Object> getPageControllerValues(
        ...
        if( PolicyHelper.isAuthorizedForActions(vreq, SimplePermission.MANAGE_MENUS.ACTION, AccessOperation.EXECUTE) ){
