...
public class ParameterUtils {
    ...
    public static Parameter createModelParameter(String name) throws Exception {
        ...
        ImplementationConfig serConfig =
                createConfig(ModelWriterTest.MODEL_CONVERSION_CLASS, "input", "serialize", true);
        implType.setSerializationConfig(serConfig);
        ImplementationConfig desConfig =
                createConfig(ModelWriterTest.MODEL_CONVERSION_CLASS, "input", "deserialize", true);
